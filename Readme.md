...
3. Program memiliki 81 aturan yang mencakup seluruh kombinasi dari 4 input (3 kategori masing-masing = 3⁴ = 81). Setiap kombinasi menentukan output kepuasan yang dihasilkan.
